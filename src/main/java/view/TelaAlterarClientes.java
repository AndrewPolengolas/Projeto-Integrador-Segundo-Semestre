...
public class TelaAlterarClientes extends javax.swing.JFrame {
    
    Cliente cliente;
    
    public TelaAlterarClientes() {
        initComponents();
        cliente = new Cliente();
    }
    
    public TelaAlterarClientes(Cliente cliente) {
        initComponents();
        this.cliente = cliente;
        this.txtNome.setText(cliente.getNome());
        this.txtCpf.setText(cliente.getCPFformatado());
        this.txtEmail.setText(cliente.getEmail());
        this.txtEndereco.setText(cliente.getEndereco());
        this.txtTel.setText(cliente.getTelefoneFormatado());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(ClienteController.Atualizar(nome, cpf, telefone, email, endereco, sexo) == true){
            JOptionPane.showMessageDialog(null, "Cliente atualizado com sucesso", "Sucesso", JOptionPane.INFORMATION_MESSAGE);
            dispose();
        }else{
            JOptionPane.showMessageDialog(null, "Erro ao atualizar o cliente tente novamente", "Erro", JOptionPane.ERROR_MESSAGE);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAlterarClientes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaAlterarClientes().setVisible(true);
            }
        });
    }
